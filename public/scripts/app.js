    ...
    <section id="container">
        <article class="tweet">
          <header class="new-tweet-header">
            <h3 class="name-h3">
              <img class="userIcon" src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/SNice.svg/1200px-SNice.svg.png">
              Name Name Name
            </h3>
            <span class="userId">@Name</span>
          </header>
            <p>Saying hi to all my tweety friends!</p>
...
$(document).ready(createTweetElement(data));
